...
?>
        <script>
            window.location.href = "admin.php?dir=admin&file=profile";
        </script>
<?php
    }
}
...
<div class="w-100">
    <div class="d-flex flex-row justify-content-between align-items-center">
        ...
        <a class="btn btn-primary rounded-4" href="admin.php?dir=admin&file=profile"><i class='bx bx-chevron-left'></i></a>
    </div>
