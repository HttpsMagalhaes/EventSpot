    ...
    <div class="sidebar-links">
      <ul class="p-0">
        ...
        <li class="tooltip-element" data-tooltip="0">
          <a href="base.php?dir=pages&file=event" data-active="0">
            <div class="icon">
        ...
        <li class="tooltip-element" data-tooltip="1">
          <a href="base.php?dir=pages&file=new_event" data-active="1">
            <div class="icon">
              <i class='bx bx-plus'></i>
              <i class='bx bxs-plus'></i>
            </div>
            <span class="link hide">Criar evento</span>
          </a>
        </li>
        <li class="tooltip-element" data-tooltip="2">
          <a href="base.php?dir=pages&file=my_events" data-active="2">
            <div class="icon">
        ...
        <li class="tooltip-element" data-tooltip="3">
          <a href="base.php?dir=pages&file=support" data-active="3">
            <div class="icon">
        ...
        <li class="tooltip-element" data-tooltip="4">
          <a href="base.php?dir=pages&file=profile" data-active="4">
            <div class="icon">
              <i class='bx bx-cog'></i>
